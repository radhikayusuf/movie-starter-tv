...
package com.example.radhikayusuf.androidtv2;
...
import com.example.radhikayusuf.androidtv2.custome.header.IconHeaderItemPresenter;
import com.example.radhikayusuf.androidtv2.custome.list_row.CustomListRow;
import com.example.radhikayusuf.androidtv2.custome.list_row.CustomListRowPresenter;
...
public class MainFragment extends BrowseFragment {
    ...
    private void loadRows() {
        ...
        for (i = 0; i < NUM_ROWS; i++) {
            ...
            mRowsAdapter.add(new CustomListRow(header, listRowAdapter));
        }
    ...
    private void setupUIElements() {
        ...
        setBrandColor(getResources().getColor(R.color.deep_black));
    ...
    protected void updateBackground(String uri) {
        mBackgroundManager.setColor(getResources().getColor(R.color.black));
    }
...
//
//        @Override
//        public android.app.Fragment createFragment(Object rowObj) {
//            Row row = (Row)rowObj;
